<div>
    <div class="form-group">
        ...
        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Ingrese el nombre de su servicio...']) !!}
    ...
    <div class="row mb-3">
        <div class="col">
            <div class="image-wrapper">
                @isset ($service->image)
                    <img id="picture" src="{{Storage::url($service->image->url)}}" alt="">
                @else
                    <img id="picture" src="{{Storage::url('default/service.jpg')}}" alt="">
                @endisset
            </div>
        </div>
        <div class="col">
